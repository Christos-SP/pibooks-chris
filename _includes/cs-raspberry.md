...
Συνολικά, το Raspberry Pi έγινε τόσο επιδραστικό γιατί επιτρέπει σε φοιτητές, εκπαιδευτικούς και makers να περάσουν γρήγορα από την ιδέα στο πρωτότυπο, χωρίς να θυσιάσουν την ποιότητα της εμπειρίας χρήστη. Και αυτό, στην ουσία, είναι το μεγάλο του “χαρτί” για τη διάδραση: δεν σε μαθαίνει μόνο να γράφεις κώδικα , σε μαθαίνει να φτιάχνεις συστήματα που μπορούν πραγματικά να χρησιμοποιηθούν.
