...
Η χρήση κουμπιών αντί για οθόνη αφής είναι μια συνειδητή εργονομική επιλογή. Εξασφαλίζει ότι η συσκευή παραμένει λειτουργική με γάντια, βρεγμένα χέρια ή σε συνθήκες παγετού.
